...
log_path = 'test_sample_log_update3_Image_Per_Bag.txt'



test_loader = data_utils.DataLoader(data_utils.DataLoader(LungDataset(source_dir,test_files),
                                     batch_size=1,
                                     collate_fn=custom_collate,
                                     **loader_kwargs))

model = torch.load('best_model_Image_Per_Bag.txt.pth')
print('Init Model')
